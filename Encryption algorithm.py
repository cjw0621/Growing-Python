...
encryptionkey = pd.read_csv(r"C:\Users\cjwhi\OneDrive\Computer\Documents\Coding\Programs\Small Coding Projects\Hash.csv", sep = ',', names = ['Character', 'Byte'], header = None, skiprows = [0])
...
message = "You are a fucking fagot"
